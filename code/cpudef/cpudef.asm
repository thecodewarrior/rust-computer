#cpudef {
    ...
    dup -> 1[7:0] @ 1[7:0]
    swap -> 1[7:0] @ 2[7:0]
    push {value} -> 1[7:0] @ 3[7:0] @ value[31:0]
    frame {value} -> 1[7:0] @ 4[7:0] @ value[31:0]
    popframe -> 1[7:0] @ 5[7:0]
    store {value} -> 1[7:0] @ 6[7:0] @ value[31:0]
    load {value} -> 1[7:0] @ 7[7:0] @ value[31:0]
